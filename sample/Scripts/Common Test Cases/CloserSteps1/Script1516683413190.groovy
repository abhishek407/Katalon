...
Path src = Paths.get(GlobalVariable.output_file_path)

Path dest = Paths.get('D:\\Katalon_CAPPM\\screenshots\\Output_file.xls')

Files.copy(src, dest, StandardCopyOption.REPLACE_EXISTING)

Path src1 = Paths.get('D:\\Katalon_CAPPM\\Standard_file\\Output_file.xls')

Path dest1 = Paths.get(GlobalVariable.output_file_path)
...
JOptionPane.showMessageDialog(null, 'Automation Test is Completed', 'CA_PPM', JOptionPane.INFORMATION_MESSAGE)
